...
local Name = "python-3.6.7-data environment"
...
prepend_path('PYTHONPATH', '/wrk/mvsjober/appl/opt/data-3.6.7/lib/python3.6/site-packages')
prepend_path('PYTHONPATH', '/appl/vis/opencv/3.4.6-GPU-py36/lib/python3.6/site-packages/cv2/python-3.6')
prepend_path('PATH', '/wrk/mvsjober/appl/opt/data-3.6.7/bin')
