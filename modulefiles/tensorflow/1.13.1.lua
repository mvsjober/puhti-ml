...
prepend_path('PYTHONPATH', '/wrk/kuu-ukko/appl/opt/tensorflow/1.13.1/lib/python3.6/site-packages')
prepend_path('PATH', '/wrk/kuu-ukko/appl/opt/tensorflow/1.13.1/bin')
